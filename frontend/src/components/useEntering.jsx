  ...
  return (
    <div>
         <div className="  h-screen w-full  " style={{backgroundImage:`url(${movies})`}}>
             ...
             <div className=' h-screen w-full bg-black opacity-75'> 
             <h1 className='text-white  text-4xl text-bolder pl-8 pt-8'>M<span className='text-5xl text-[#BE4502] '>V</span>T</h1>
              ...
              <div className='flex justify-center' style={{justifyContent: "center"}}> 
                <Link to="./signup">
              <button className='h-20 w-48 bg-yellow-700 block mt-10 text-white text-2xl ml-24'>Signup</button>
              </Link>
              <Link to="./login">
              <button className='h-20 w-48 bg-yellow-700 block mt-10 text-white text-xl ml-24'>Login</button>
              </Link>
              </div>
             </div>
         </div>
