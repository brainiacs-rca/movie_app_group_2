    ...
    <div className="  h-screen w-full" style={{backgroundImage:`url(${movies})`}}>
      <div className='h-screen w-full pt-72'>
          ...
          <i className='text-[#BE4502] text-center text-4xl  '><FaCheckCircle /></i>
            ...
            <button className='flex h-12 w-40 bg-yellow-700 pl-8 pt-2 ml-auto mr-auto text-white text-xl mt-6'>Continue <i className='text-white pt-3 pl-3 text-xl'><FaArrowRight /></i></button>
          </div>
