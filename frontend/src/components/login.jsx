...
function Login() {
  ...
  return (
    ...
    <div className="  h-screen w-full pt-36" style={{backgroundImage:`url(${movies})`}}>
      <div className='h-[60vh] w-[35vw] bg-black opacity-[0.7]  ml-auto mr-auto block pl-28 pt-12 '>
         ...
         <form action="" onSubmit={handleSubmit} >
             ...
             <button  className='h-20 w-48 bg-[#BE4502] block mt-10 text-white text-xl ml-24' type='submit'>Log in</button>
             {/* </Link> */}
